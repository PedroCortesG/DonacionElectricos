const data = {
    ...
    "tipo-dispositivo": ["Pantalla",
        "Notebook", "Tablet", "Celular",
        "Consola", "Mouse", "Teclado",
        "Impresora", "Parlante",
        "Audífonos", "Otro"
    ],
    "estado-dispositivo": ["Funciona perfecto", "Funciona a medias", "No funciona"]
};
...
const updateComunas = () => {
    ...
    if (data.regiones[selectedRegion].comunas) {
...
const poblarTipos = () => {
    let tipoSelect = document.getElementById("tipoDispositivo");
    let tipo = data["tipo-dispositivo"];
    tipoSelect.innerHTML = "";
    if (tipo) {
        tipo.forEach(tipoDis => {
          let option = document.createElement("option");
          option.value = tipoDis;
          option.text = tipoDis;
...
const poblarEstado = () => {
    let estadoSelect = document.getElementById("estadoDispositivo");
    let estado = data["estado-dispositivo"];
    estadoSelect.innerHTML = "";
    if (estado) {
        estado.forEach(estadoDis => {
          let option = document.createElement("option");
          option.value = estadoDis;
          option.text = estadoDis;

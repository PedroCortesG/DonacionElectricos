...
const validateDonador = () => {
    ...
    let infoDonante = document.forms["formulario"];
...
const validateDonaciones = () => {
    let formDonacion = document.forms["formulario"];
    let allValid = true;
    ...
    for (let i = 1; i <= contador; i++){
        contador--;
        let nombreDispositivo = formDonacion["nombreDispositivo"+i].value;
        let descripcionDispositivo = formDonacion["descripcionDispositivo"+i].value;
        let tipoDispositivo = formDonacion["tipoDispositivo"+i].value;
        let annosDispositivo = formDonacion["annosDispositivo"+i].value;
        let estadoDispositivo = formDonacion["estadoDispositivo"+i].value;
        let fotosDispositivo = formDonacion["fotosDispositivo"+i].files;
